defmodule ReproEmptyDraw.Scene.Primitives do
  @moduledoc """
  Sample scene.
  """
  ...
  alias ReproEmptyDraw.Component.Nav
  alias ReproEmptyDraw.Component.Notes

  @bird_path :code.priv_dir(:repro_empty_draw)
