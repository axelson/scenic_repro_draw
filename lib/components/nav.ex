defmodule ReproEmptyDraw.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", ReproEmptyDraw.Scene.Sensor},
           {"Primitives", ReproEmptyDraw.Scene.Primitives},
           {"Components", ReproEmptyDraw.Scene.Components},
           {"Transforms", ReproEmptyDraw.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
